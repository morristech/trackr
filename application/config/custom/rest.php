...
/*
  ...
  |
 */
$config['rest_keys_table'] = 'engine_api_keys';
...
if (defined ('ENVIRONMENT'))
{
  switch (ENVIRONMENT)
  {
    ...
    case 'production':
      ...
      break;
    default:
      exit ('API server is not configured properly.');
  }
}
...
/*
  ...
  |
 */
$config['rest_logs_table'] = 'engine_api_logs';
...
/*
  ...
  |
 */
$config['rest_limits_table'] = 'engine_api_limits';
